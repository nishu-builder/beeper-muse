...
func main() {
	...
	bridge := mxmain.BridgeMain{Name: "beeper-muse", Description: "A direct Beeper-Muse browser bridge", URL: "https://github.com/nishu-builder/beeper-muse", Version: "0.4.0", Connector: c}
