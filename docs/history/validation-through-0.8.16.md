# Validation history through 0.8.16

This is the original chronological record, including failures later resolved.
Use [current validation](../validation.md) and the [active ledger](../parity.md)
for present status. Old build commands here describe the toolchain at the time.
